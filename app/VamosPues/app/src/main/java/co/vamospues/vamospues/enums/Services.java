...
/**
 * Created by Manuela Duque M on 07/02/2017.
 */
...
public class Services {
    ...
    public static final String AUTH_CHECK_TOKEN_SERVICE = "auth/check";
    public static final String REVIEW_ADD_SERVICE = "review/add";
